"""Tests for the assignment probe: environment factory, greedy insertion, and ERB demo format."""
...
class ErbDemoFormatTest(unittest.TestCase):
    ...
    def test_demos_have_required_fields_and_no_double_claim(self) -> None:
        ...
        for t in demos:
            ...
            # SAC.update() indexes this field, so the chosen node must lie in the stored mask.
