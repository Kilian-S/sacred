...
Run: OMP_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 PYTHONPATH=. .venv/bin/python scratch/gen38_v2_conditioned.py --seed 0 \
...
from scratch.gen38_enemy_id import instance_apparatus
from scratch.gen38_narratives import MEMBERS
