...
unrestricted optimiser kept only as context.
  ...
  Reported: absolute threat vs the unrestricted 0.0215, free lanes, per-model split.
    ...
    PYTHONPATH=. python scratch/gen39_phase1e.py --n 4 --rounds 2
"""
...
from scratch.gen39_compose import (BASE_URL, FIELDS, K, KEY, MODELS, OUTDIR, g33, narva_base)
from scratch.gen39_phase1d import after_action, grounding, parse_intent
