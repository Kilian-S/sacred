...
Design choices, disclosed:
  ...
  * Build is incremental and per-(map, family): the three oracle-only families need no GPU box
    ...
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen39_zeroshot2.py --selfcheck
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen39_zeroshot2.py --build \
    ...
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen39_zeroshot2.py --score --workers 6
"""
...
from scratch.gen39_zeroshot import (ARMS, STEP5, _init, base_for, load_ckpts, search_llm,
                                    search_local, search_random, selfcheck)
from scratch.gen39_phase1f import map_digest
