...
arms at temperature 0, the thinking arm at 0.6 / seed 0 / max_tokens 16000; traces banked.
    ...
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen43_exam.py --model qwen3-27b
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen43_exam.py --model qwen3-27b --thinking on
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen43_exam.py --model qwen35-2b \
