...
echo "=== 1c START $(date) ==="
PYTHONPATH=. $PY scratch/gen39_phase1c.py --robust --iter --curated
echo "=== 1d START $(date) ==="
PYTHONPATH=. $PY scratch/gen39_phase1d.py --rounds 6 --n 3
echo "=== 1e START $(date) ==="
PYTHONPATH=. $PY scratch/gen39_phase1e.py --n 4 --rounds 2
echo "=== 1e THINKING RIDER START $(date) ==="
PYTHONPATH=. $PY scratch/gen39_phase1e_thinking.py
echo "=== ALL DONE $(date) ==="
