...
Builds the 71-33 game EXACTLY as scratch/b2_llm_benchmark.py does (same env call, same
...
Run: OMP_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 PYTHONPATH=. .venv/bin/python \
     scratch/b2_7133_anchor_probe.py
...
from scratch.gen40_dyn_sensitivity import cell
