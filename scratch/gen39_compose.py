...
reported beside it. The oracle-searched best force (choose_force) is the reported ceiling.
    ...
    PYTHONPATH=. python scratch/gen39_compose.py --dry          # offline pipeline validation
    PYTHONPATH=. python scratch/gen39_compose.py --live         # the ~32-call live run
    PYTHONPATH=. python scratch/gen39_compose.py --score        # (re)score saved forces
"""
