...
the step-5 originals, imported rather than re-implemented.
    ...
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen44_budget_sweep.py --config qwen35-4b \
        --base http://cv-iits-w05.tail5b8d80.ts.net:8006/v1
    # gateway configurations
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen44_budget_sweep.py --config llama-3.3-70b
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen44_budget_sweep.py --config qwen3-27b --thinking on
    # the no-LLM controls (Mac only, no box)
    PYTHONPATH=. ../sacred/.venv/bin/python scratch/gen44_budget_sweep.py --config local16
"""
...
from scratch.gen39_compose import KEY, g33
from scratch.gen39_phase1f import SCHEMA, llm_prompt, map_digest
from scratch.gen39_zeroshot import _init, base_for, score, search_local, search_random
