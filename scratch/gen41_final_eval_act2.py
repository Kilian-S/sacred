#!/usr/bin/env python3
"""gen41 ACT-2 final evaluation (post-training, ORACLE/EVAL-ONLY): the high-precision pass at the
...
Run: OMP_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 PYTHONPATH=. .venv/bin/python \
     scratch/gen41_final_eval_act2.py
Writes models/runs/gen41_act2/final_eval.json
"""
...
W, TAU, K, KX, N, BAND = 3, 0.15, 2, 12, 3, (0.15, 0.95)
T_FINAL = 20_000
RUN_DIR = Path("models/runs/gen41_act2")
