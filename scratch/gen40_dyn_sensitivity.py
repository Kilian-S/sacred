...
dynamic optima via Karp (scratch/dyn_exact.py), core-restricted where R^w > FULL_STATE_CAP,
...
Run: OMP_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 PYTHONPATH=. .venv/bin/python \
     scratch/gen40_dyn_sensitivity.py
...
def enum_windows(sub, w, R):
    ...
    ordering convention to scratch/dyn_exact.py). Returns (dec [n,w] in subset indices,
