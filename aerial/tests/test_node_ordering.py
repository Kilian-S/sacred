"""Pins `node_index_map` to `featurize_state`'s actual row order (sorted node ids, not dict
insertion order), on a synthetic adversarial ordering and on the real Kaliningrad envs."""
