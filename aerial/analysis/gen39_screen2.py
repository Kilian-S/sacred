...
process with every maths thread pool capped to one, and a block whose output file exists is skipped.
    ...
    PYTHONPATH=. python analysis/gen39_screen2.py --launch --workers 9  # the full sweep
    PYTHONPATH=. python analysis/gen39_screen2.py --merge
"""
...
from analysis.gen39_screen import (CONCEAL_REACH, DOCTRINE, FIELDS, HIDDEN_LETH, KINDS, MAPS, PATH,
