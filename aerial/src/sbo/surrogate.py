...
def train_surrogate(
    ...
    *,
    ...
    Args:
        features: array or tensor of shape (num_samples, input_dim), holding the depot indicator
            and the demands.
        targets: array or tensor of shape (num_samples,) or (num_samples, 1), holding expected
            adversarial travel ticks.
